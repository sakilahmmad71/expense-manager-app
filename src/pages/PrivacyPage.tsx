			...
			<div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-300">
				...
				<Card id="user-rights">
					...
					<CardContent className="space-y-3 text-gray-700">
						...
						<ul className="list-disc list-inside space-y-1 ml-2">
							<li>
								<strong>Access:</strong> View all your personal data stored in
								the application
							</li>
							<li>
							...
							<li>
								<strong>Export:</strong> Download your expense data in CSV
								format
							</li>
							<li>
				...
				<Card id="policy-changes">
					...
					<CardContent className="space-y-3 text-gray-700">
						<p>
							...
							Continued use of Expenser after changes constitutes acceptance of
							the updated policy.
						</p>
					</CardContent>
				</Card>
