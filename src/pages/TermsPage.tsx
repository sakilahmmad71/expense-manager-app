	...
	return (
		<div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-300">
				...
				<CardContent className="space-y-3 text-gray-700">
					<div>
						...
						<p>
							...
							grant us a limited license to use, store, and process Your Content
					...
					<div>
						...
						<p>
							...
							of posting it. You represent that you have all necessary rights to
							Your Content and that it does not violate any laws or third-party
							rights.
						</p>
					</div>
					<div>
			...
			<Card id="intellectual-property">
				...
				<CardContent className="space-y-3 text-gray-700">
					<p>
						...
						functionality, design, code, and visual elements, is owned by Shakil
						Ahmed and is protected by international copyright, trademark, and
						other intellectual property laws.
					</p>
					<p>
						Expenser is released as open-source software under the MIT License.
						You may view, fork, and contribute to the source code on GitHub,
				...
				<CardContent className="space-y-3 text-gray-700">
					<div>
						...
						<p>
							...
							We may experience downtime for maintenance, updates, or unforeseen
							circumstances.
						</p>
					</div>
					<div>
				...
				<CardContent className="space-y-3 text-gray-700">
					<div>
						...
						<p>
							...
							Upon deletion, all Your Content will be permanently removed within
							30 days.
						</p>
					</div>
					<div>
			...
			<Card id="liability">
				...
				<CardContent className="space-y-3 text-gray-700">
					<p className="uppercase font-semibold">
						TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL EXPENSER,
						ITS DEVELOPERS, OR CONTRIBUTORS BE LIABLE FOR ANY INDIRECT,
			...
			<Card id="changes-to-terms">
				...
				<CardContent className="space-y-3 text-gray-700">
					<p>
						...
						and, where appropriate, through email or in-app notifications.
					</p>
					<p>
						...
						the changes, you must stop using the Service and delete your
						account.
					</p>
				</CardContent>
			</Card>
