		...
		<div className="py-8 px-4 sm:px-6 min-h-screen">
			<div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-300">
					...
					<CardContent className="space-y-4 text-gray-700">
						<div>
							...
							<ul className="list-disc list-inside space-y-1 ml-6">
								...
								<li>
									<strong>API Security:</strong> All API endpoints require
					...
					<CardContent className="space-y-4 text-gray-700">
						<div>
							...
							<ul className="list-disc list-inside space-y-1 ml-2">
								...
								<li>
									<strong>No Plain Text Storage:</strong> We never store
								...
								<li>
									<strong>Secure Password Reset:</strong> Time-limited,
						...
						<div>
							...
							<ul className="list-disc list-inside space-y-1 ml-2">
								...
								<li>
									<strong>Token Expiration:</strong> Access tokens expire after
									a set period
								</li>
								<li>
						...
						<div>
							...
							<ul className="list-disc list-inside space-y-1 ml-2">
								...
								<li>
									<strong>Secure Flow:</strong> Authorization code flow with
				...
				<Card id="database-security">
					...
					<CardContent className="space-y-3 text-gray-700">
						<ul className="list-disc list-inside space-y-1">
							<li>
								<strong>PostgreSQL:</strong> Production-grade relational
								database with advanced security features
							</li>
							<li>
							...
							<li>
								<strong>Connection Pooling:</strong> Secure and efficient
								database connections
							</li>
							<li>
								<strong>Regular Backups:</strong> Automated encrypted backups
					...
					<CardContent className="space-y-4 text-gray-700">
						...
						<div>
							...
							<ul className="list-disc list-inside space-y-1 ml-2">
								...
								<li>
									<strong>CORS:</strong> Controlled cross-origin resource
									sharing
								</li>
								<li>
				...
				<Card id="application-security">
					...
					<CardContent className="space-y-3 text-gray-700">
						<ul className="list-disc list-inside space-y-1">
							...
							<li>
								<strong>CSRF Protection:</strong> Token-based CSRF protection
							...
							<li>
								<strong>ESLint Security Rules:</strong> Automated security
								linting
							</li>
						</ul>
					</CardContent>
					...
					<CardContent className="space-y-3 text-gray-700">
						...
						<ul className="list-disc list-inside space-y-1">
							<li>
								...
								with at least 12 characters, mixing uppercase, lowercase,
								numbers, and symbols
							</li>
							<li>
								<strong>Enable Remember Me Carefully:</strong> Only use
								"Remember Me" on trusted personal devices
							</li>
							<li>
				...
				<Card id="open-source">
					...
					<CardContent className="space-y-3 text-gray-700">
						<p>
							...
							implementation, report vulnerabilities, and contribute
				...
				<Card id="responsible-disclosure">
					...
					<CardContent className="space-y-3 text-gray-700">
						<p>
							If you discover a security vulnerability, please help us protect
							our users by reporting it responsibly:
						</p>
				...
				<Card id="security-contact">
					...
					<CardContent className="space-y-3 text-gray-700">
						<p>
							For security concerns, questions, or to report a vulnerability:
						</p>
